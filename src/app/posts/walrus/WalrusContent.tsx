// src/app/posts/walrus/WalrusContent.tsx
"use client";
...
export default function WalrusContent() {
  ...
  return (
    <PostShell title="When I Am the Walrus" subtitle="November 2025">
      ...
      <Prose>
        ...
        seems that I live as I dream,
        <Footnote index={2} vis={vis}>
          Conrad, <i>Heart of Darkness</i>.
        </Footnote>
        seems I am clawing, gasping, and barely breaching
        <Footnote index={3} vis={vis}>
          <i>Dev.</i>, 22.
        </Footnote>
        from three things in this speech,
        <Footnote index={4} vis={vis}>
          WUDC 2025, Sydney C.
        </Footnote>
        two reasons why,
      ...
      <Prose>
        ...
        as much is yours.
        <Footnote index={13} vis={vis}>
          Locke, <i>Second Treatise</i>.
        </Footnote>
        Look what there is to gain! You parse all that is legible of late and
        the memories hydrate in quick succession, you employ all that’s been
      ...
      <Prose>
        ...
        <Footnote index={14} vis={vis}>
          Fairlife.
        </Footnote>
        can save. You point out that such deafening displays of allusion might
        hamstring the non-associative, foreclose novelty, even inspire LLM-type
        ...
        <Footnote index={17} vis={vis}>
          Cameron, <i>Terminator II.</i>
        </Footnote>
        and condemn you to the flute.
        <Footnote index={18} vis={vis}>
          Kurosawa, <i>Ran.</i>
        </Footnote>
        I throw a handkerchief at you
        <Footnote index={19} vis={vis}>
          Shakespeare, <i>Othello</i>.
        </Footnote>
      ...
      <Prose>
        ...
        Sophie I cannot understand. Can you weep over her? She was not pressured
        into a five-part “At The Copa.”
        <Footnote index={22} vis={vis}>
          Bit around: DG.
        </Footnote>
        ...
        <Footnote index={24} vis={vis}>
          Scaffolding: Kierkegaard, <i>Fear and Trembling</i>.
        </Footnote>
        I fall down—I am brought to my knees by the millions of bits that cry
        out in terror and are suddenly silenced. How do you not cry out! The
      ...
      <Prose>
        ...
        Uneasy should be any that hears the hitch.
        <Footnote index={26} vis={vis}>
          Shakespeare, <i>Henry IV</i>.
        </Footnote>
        Our fabric is so light, so thinly strung that every assertion risks
        slicing us through a space’s time. Hooray that our swift faculties can
        calculate every line, that we can arm ourselves with deniabilities and
        hold the balance in a language of feints. Fear no misunderstanding: the
        evaluation bar does not struggle with subjunctives. Impalpable
        initiatives still hallow immortal squares—we merely paint with brushes
        dipped in the whispering currents, of unborn sequences and unknown
        sacrifice. Don’t we always speak with possibilities? So few moves will
        be played, how could we be poorer for thinking every turn? Do we even
        need the end? Oh, Sophie, the promised end!
        <Footnote index={27} vis={vis}>
          Shakespeare, <i>King Lear</i>.
        </Footnote>
        We are safer here in machination. Can you really bear the toppled crown?
        See tearlessly him that couldn’t see far enough? If you do not shudder
        at Qe2,
        <Footnote index={28} vis={vis}>
          World Chess Championship 2023, Final Tiebreak.
        </Footnote>
      ...
      <Prose>
        ...
        <Footnote index={30} vis={vis}>
          More: <i>Aftersun</i>.
        </Footnote>
        Where in pale blue and a hint of pink the sun dresses the coast. Where
        glimmers pool as rocks trap the tide and basketballs arc in a budding
        dusk. I ask if you have any water. <i>Sorry, I mean I want water.</i> A
        band strums to the waves nearby. <i>Will you be going tomorrow?</i>{" "}
        Jesus, no, I say I want to go with you. Their rhythm rises in the purple
        twilight, and my feet begin to tap. Fuck, no, those were mistakes! I
        didn’t hear you—what song? Please, I know I ordered the peppermint
        mocha, but he knew it, too. I asked for coffee, and I woke up to climb,
