    ...
    <PostShell title="When I Am The Walrus" subtitle="November 2025" visible={false}>
      ...
      <p>
			...
			<p>
				...
				seems that I live as I dream,<Footnote index={3} vis={vis}>Conrad, <i>Heart of Darkness</i>.</Footnote> 
				seems I am clawing, gasping, and barely breaching<Footnote index={4} vis={vis}><i>Dev.</i>, 22.</Footnote> 
				three things in this speech,<Footnote index={5} vis={vis}>WUDC 2025, Sydney C.</Footnote> 
				two reasons why,<Footnote index={6} vis={vis}>"Writing about Oneself."</Footnote> 
				or to become one?<Footnote index={7} vis={vis}><i>Dev.</i>, 1.</Footnote> 
				No, scaring from the dead rat’s five more,<Footnote index={8} vis={vis}>AM.</Footnote> 
				the V4,<Footnote index={9} vis={vis}>Ascent, "The Impaler."</Footnote> 
				the face you keep in a jar by the door, who is this for?<Footnote index={10} vis={vis}>The Beatles, "Eleanor Rigby."</Footnote> 
				All the hermetic logic,<Footnote index={11} vis={vis}>DZ</Footnote> 
				where does it all belong? Probably not Here, There and Every—wait.<Footnote index={10} vis={vis}>The Beatles, "—where."</Footnote>  
			...
			<p>
				...
				doesn’t disintegrate some vocal muscle that no multiple of 42 can save. 
				...
				I point to Apollo.<Footnote index={14} vis={vis}><i>Star Trek</i>, "Who Mourns for Adonais?"</Footnote> 
				I point to Alexander.<Footnote index={15} vis={vis}><i>Star Trek</i>, "Plato's Stepchildren."</Footnote> 
				I extend my hand into a sharp metal spear<Footnote index={16} vis={vis}>Cameron, <i>Terminator II.</i></Footnote> 
				and condemn you to the flute.<Footnote index={17} vis={vis}>Kurosawa, <i>Ran.</i></Footnote> 
				I throw a handkerchief at you<Footnote index={18} vis={vis}>Shakespeare <i>Othello</i>.</Footnote> 
				and ask whether you’ll fight back.<Footnote index={19} vis={vis}><i>Cheers</i>, "Homicidal Ham."</Footnote> 
			...
			<p>
				Sophie sang “Losing My Religion” for one minute and fifty seconds.<Footnote index={19} vis={vis}>Wells, <i>Aftersun</i>.</Footnote> 
				Sophie I cannot understand. 
				Can you weep over her? 
				She was not pressured into a five-part “At The Copa.”<Footnote index={19} vis={vis}>DG, MK.</Footnote> 
				She was not doused in vodka for holding the 40-second E.<Footnote index={19} vis={vis}>The Beatles, "A Day in the Life."</Footnote> 
				When I think of Sophie, I am as though annihilated, as though paralyzed.<Footnote index={19} vis={vis}>Kierkegaard, <i>Fear and Trembling</i>.</Footnote>
			...
			<p>
				...
				Uneasy should be any that hears the hitch.<Footnote index={19} vis={vis}>Shakespeare, <i>Henry IV</i>.</Footnote>  
				...
				If you do not shudder at Qe2,<Footnote index={18} vis={vis}>World Chess Championship, Final Tiebreak.</Footnote>  
				if Rg6 does not drench you in—does not make you tread nausea, you do not know me. 
			</p>
			<p>
				We both know it is better to speak.<Footnote index={18} vis={vis}>Guadagnino.</Footnote> 
				...
				Weber has arrived to make me dance until I die.<Footnote index={18} vis={vis}>DZ.</Footnote> I will speak anyway. 
				I promise that my flesh will draw apart an abstract standing. 
				A new splatter of fortitude, this, a praying face to the sea.<Footnote index={18} vis={vis}><i>Redwoods</i>R.</Footnote> 
			</p>
			<p style={{ textIndent: "2em" }}>
			...
			<p>
				...
				Equipped with new lows of information access and a taste for sensory risk, I mean to abandon the self to a new being and hopefully other ones, too. 
				I hope to think less, to be affect and be so. Ultimately, to leave a wake. 
			</p>
    </PostShell>
  );
}
